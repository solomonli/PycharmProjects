...
def test_answer_placeholders():
    ...
    # placeholder tests
    placeholder_smart_compare(placeholders[0], """food, price in prices.items()""", human_nr=1     )

    placeholder_smart_compare(placeholders[1], """price""", human_nr=2     )

    placeholder_smart_compare(placeholders[2], """price""", human_nr=3     )
